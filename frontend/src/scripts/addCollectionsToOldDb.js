// src/scripts/addCollectionsToOldDb.js
// Импортируем напрямую из firebase, без использования файла конфигурации
import { initializeApp } from "firebase/app";
import { getFirestore } from "firebase/firestore";
import { doc, setDoc, Timestamp } from "firebase/firestore";

// ⚠️ ВАЖНО: Здесь твои реальные значения из .env
...
// Инициализируем Firebase напрямую
const app = initializeApp(firebaseConfig);
const db = getFirestore(app);

console.log('========================================');
console.log('🚀 ДОБАВЛЕНИЕ КОЛЛЕКЦИЙ В СТАРУЮ БАЗУ');
console.log('========================================');
console.log('📁 Проект:', firebaseConfig.projectId);
console.log('');

async function addCollectionsToOldDb() {
  ...
  try {
    ...
    console.log('\n✨ ГОТОВО! Теперь новые коллекции добавлены в старую базу.');
